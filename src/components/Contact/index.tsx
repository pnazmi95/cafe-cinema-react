...
const Contact: React.FunctionComponent<IContactProps> = (
  ...
  //
  return (
    <section className="dark:bg-dark-primary bg-light-primary select-none flex justify-center">
      <div className="grid min-h-[calc(100vh-176px)] max-w-7xl grid-flow-row grid-cols-2 justify-center overflow-y-auto content-center items-center">
        <div className="col-span-2 flex h-full w-full flex-col justify-around bg-light-primary p-12 text-light-heading dark:bg-dark-primary dark:text-dark-heading sm:col-span-1">
          <div>
        ...
        <div className="col-span-2 flex h-full w-full flex-col items-center justify-around bg-light-primary p-12 text-light-heading dark:bg-dark-primary dark:text-dark-heading sm:col-span-1">
          <form
            autoComplete="off"
