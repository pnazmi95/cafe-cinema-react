...
const MovieDetail: React.FunctionComponent<MovieDetailProps> = ({
  ...
  return (
    <div className="flex justify-center bg-light-primary dark:bg-dark-primary w-screen overflow-y-auto">
      <section className="flex h-auto max-w-7xl select-none flex-col justify-between overflow-y-scroll bg-light-primary text-2xl uppercase text-light-content dark:bg-dark-primary dark:text-dark-content md:h-[calc(100vh-176px)] md:overflow-hidden">
